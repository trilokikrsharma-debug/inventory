...
CREATE INDEX IF NOT EXISTS `idx_sitems_tenant_sale`
    ON `sale_items`(`company_id`, `sale_id`);

-- Covers: JOIN products on sale_items — product summary reports
CREATE INDEX IF NOT EXISTS `idx_sitems_tenant_product`
...
CREATE INDEX IF NOT EXISTS `idx_purchases_tenant_supplier`
    ON `purchases`(`company_id`, `supplier_id`, `deleted_at`);

-- ──────────────────────────────────
-- PURCHASE ITEMS
-- ──────────────────────────────────
CREATE INDEX IF NOT EXISTS `idx_pitems_tenant_purchase`
...
CREATE INDEX IF NOT EXISTS `idx_payments_tenant_supplier`
    ON `payments`(`company_id`, `supplier_id`, `deleted_at`);

-- ──────────────────────────────────
-- QUOTATIONS
-- ──────────────────────────────────
CREATE INDEX IF NOT EXISTS `idx_quotations_tenant_date`
...
-- ──────────────────────────────────
CREATE INDEX IF NOT EXISTS `idx_sale_returns_tenant`
