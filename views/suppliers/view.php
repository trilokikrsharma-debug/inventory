...
<div class="row g-3">
    <div class="col-lg-4"><div class="card detail-card"><div class="card-body">
        <h5 class="mb-3"><?= Helper::escape($supplier['name']) ?></h5>
        <div class="table-responsive"><table class="table table-sm mb-0 detail-table">
    ...
    <div class="col-lg-8"><div class="card detail-card">
        <div class="card-header"><h6><i class="fas fa-book me-2"></i>Ledger</h6>
            <form class="report-filter-form" method="GET"><input type="hidden" name="page" value="suppliers"><input type="hidden" name="action" value="view_supplier"><input type="hidden" name="id" value="<?= $supplier['id'] ?>">
                <input type="date" name="from_date" class="form-control form-control-sm report-filter-field" value="<?= Helper::escape($_GET['from_date'] ?? '') ?>"><input type="date" name="to_date" class="form-control form-control-sm report-filter-field" value="<?= Helper::escape($_GET['to_date'] ?? '') ?>"><button class="btn btn-sm btn-primary"><i class="fas fa-filter"></i></button>
