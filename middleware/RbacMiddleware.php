...
class RbacMiddleware implements MiddlewareInterface {
    ...
    private const PERMISSIONS = [
        'products' => [
            ...
            'download_template' => 'products.create',
            'edit' => 'products.edit',
        ...
        'customers' => [
            ...
            'download_template' => 'customers.create',
            'edit' => 'customers.edit',
        ...
        'suppliers' => [
            ...
            'import' => 'suppliers.create',
            'download_template' => 'suppliers.create',
            'edit' => 'suppliers.edit',
        ...
        'api' => [
            'index' => 'settings.manage',
            'generate' => 'settings.manage',
            'revoke' => 'settings.manage',
        ],
        'company' => [
            'index' => 'settings.manage',
        ],
        ...
        'warehouses' => [
            ...
            'edit' => 'catalog.manage',
            'delete' => 'catalog.manage',
            'set_default' => 'catalog.manage',
            'transfer' => 'catalog.manage',
            'approve_transfer' => 'catalog.manage',
            'reject_transfer' => 'catalog.manage',
            'search_products' => 'catalog.manage',
        ],
        'insights' => [
            'index' => 'reports.view',
        ...
        'hr' => [
            ...
            'view_employee' => 'settings.manage',
            'delete' => 'settings.manage',
            'attendance' => 'settings.manage',
            'mark_attendance' => 'settings.manage',
            'leaves' => 'settings.manage',
            'create_leave' => 'settings.manage',
            'approve_leave' => 'settings.manage',
            'reject_leave' => 'settings.manage',
            'manager_approve_leave' => 'settings.manage',
            'manager_reject_leave' => 'settings.manage',
            'payroll' => 'settings.manage',
            'process_payroll' => 'settings.manage',
            'approve_payroll' => 'settings.manage',
            'unlock_payroll' => 'settings.manage',
            'save_payroll_policy' => 'settings.manage',
            'mark_payroll_paid' => 'settings.manage',
            'update_payroll_item' => 'settings.manage',
            'payslip' => 'settings.manage',
            'holidays' => 'settings.manage',
            'create_holiday' => 'settings.manage',
            'shifts' => 'settings.manage',
            'create_shift' => 'settings.manage',
            'leave_balances' => 'settings.manage',
            'update_leave_balance' => 'settings.manage',
            'save_leave_policy' => 'settings.manage',
            'process_leave_accruals' => 'settings.manage',
        ],
    ];
