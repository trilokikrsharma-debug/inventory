...
--
-- SAFETY: Runner applies idempotent guards for re-execution.
...
CREATE INDEX `idx_sr_company` ON `sale_returns`(`company_id`, `deleted_at`);
...
CREATE INDEX `idx_sri_company` ON `sale_return_items`(`company_id`);
...
CREATE INDEX `idx_pr_company` ON `purchase_returns`(`company_id`, `deleted_at`);
...
CREATE INDEX `idx_pri_company` ON `purchase_return_items`(`company_id`);
