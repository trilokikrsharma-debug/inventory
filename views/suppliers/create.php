...
<div class="page-header"><nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= APP_URL ?>">Dashboard</a></li><li class="breadcrumb-item"><a href="<?= APP_URL ?>/index.php?page=suppliers">Suppliers</a></li><li class="breadcrumb-item active">Add</li></ol></nav></div>
...
<form method="POST"><?= CSRF::field() ?>
    <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label">Tax Number</label><input type="text" name="tax_number" class="form-control"></div>
    ...
    <div class="mt-4"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Save</button> <a href="<?= APP_URL ?>/index.php?page=suppliers" class="btn btn-outline-secondary">Cancel</a></div>
</form></div></div>
