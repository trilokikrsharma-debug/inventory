...
<div class="row g-3">
        ...
        <div class="card detail-card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 text-md-end"><strong>Date:</strong> <?= Helper::formatDate($purchase['purchase_date']) ?><br><small class="text-muted">Ref: <?= Helper::escape($purchase['reference_number'] ?? '-') ?></small><?php if (!empty($purchase['warehouse_name'])): ?><br><small class="text-muted">Warehouse: <?= Helper::escape($purchase['warehouse_name']) ?></small><?php endif; ?></div>
                </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card detail-card mt-3"><div class="card-body"><strong>Note:</strong><br><?= nl2br(Helper::escape($purchase['note'])) ?></div></div>
        <?php endif; ?>
