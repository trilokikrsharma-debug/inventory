...
<div class="card mb-3 report-filter-card"><div class="card-body py-2">
    <form class="report-filter-form" method="GET"><input type="hidden" name="page" value="reports"><input type="hidden" name="action" value="profit">
...
<div class="card report-data-card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table report-data-table mb-0">
